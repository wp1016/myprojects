	...
	var addonDialog = function( editor, dialogType )
	{
		return {
			...
			onOk : function()
			{
				...
				var tempvar='<table width="450">\r    <tbody>\r        <tr>\r            <td width="20" height="30"><a target="_blank" href="'+addonUrl+'"><images border="0" align="middle" src="/plus/images/addon.gif" alt="" /></a></td>\r            <td><a target="_blank" href="'+addonUrl+'"><u>'+addonTitle+'</u></a></td>\r        </tr>\r    </tbody>\r</table>';
