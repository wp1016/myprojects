    ...
    for ( ; i < imgNum; ) {
        ...
        for ( var j = 0; j < imgColNum; j++, i++ ) {
            ...
            if ( faceImage ) {
                ...
                textHTML.push( '<span>' );
                textHTML.push( '<images  style="background-position:left ' + offset + 'px;" title="' + infor + '" src="' + emotion.SmileyPath + (editor.options.emotionLocalization ? '0.gif" width="' : faceImage+'" width="') + iWidth + '" height="' + iHeight + '"></images>' );
                textHTML.push( '</span>' );
            } else {
